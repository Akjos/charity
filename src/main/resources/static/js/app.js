    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            if (this.currentStep == 5) {
                ...
                let pickUpDate = $('input[name="pickUpDate"]').val();
                if (!!pickUpDate) {
                    $('#pickUpDateSum').text(pickUpDate);
                }

                let pickUpTime = $('input[name="pickUpTime"]').val();
                if (!!pickUpTime) {
                    $('#pickUpTimeSum').text(pickUpTime);
                }

                let pickUpComment = $('textarea[name="pickUpComment"]').val();
                if (!!pickUpComment) {
                    $('#pickUpCommentSum').text(pickUpComment);
                }
